...
function CourseList(props) {
    ...
    const courseItems = props.courses.map((course) => {
        ...
        return (
            ...
            >
                ...
                >
                    <div className="course-id-label">{course.abbreviation}</div>
                    <div
                        className={
                            course.isCompleted
                                ? "course-indicator completed"
                                : "course-indicator"
                        }
                    ></div>
                </div>
    ...
    return (
        <div className="right">
            <div className="font-semibold bg-gray-200 text-gray-700 py-5 px-6 sm:py-6 sm:px-8 sm:rounded-t-md">
                Degree Courses
            </div>
