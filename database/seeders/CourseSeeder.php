    ...
    private function getCourses()
    {
        return
            [
                ...
                ["title" => "Rhetoric and Composition", "abbreviation" => "ENGL 15",
                 'type' => "ENGL",
                ...
                ["title" => "College Algebra II", "abbreviation" => "MATH 22",
                 'type' => "MATH",
                ...
                ["title" => "Plane Trigonometry", "abbreviation" => "MATH 26",
                 'type' => "MATH",
                ...
                ["title" => "Introductory Microeconomic Analysis and Policy", "abbreviation" => "ECON 102",
                 'type' => "ECON",
                 "description" => "Methods of economic analysis and their use; price determination;
                 theory of the firm; distribution.",
                 "credits" => 3,
                ],
                ["title" => "Introductory Macroeconomic Analysis and Policy", "abbreviation" => "ECON 104",
                 'type' => "ECON",
                 "description" => "National income measurement; aggregate economic models; money and income;
                 policy problems.",
                 "credits" => 3,
                ],
                ["title" => "Electrical Circuits and Power Distribution", "abbreviation" => "EE 211", 'type' => "EE",
                ...
                ["title" => "Programming Language Concepts", "abbreviation" => "CMPSC 461", 'type' => "CMPSC",
                 "description" => "Fundamental concepts of programming language design, specifications,
                 and implementation; programming language paradigms and features; program verification.",
                 "credits" => 3
                ],
                ["title" => "Data Structures and Algorithms", "abbreviation" => "CMPSC 465", 'type' => "CMPSC",
                ...
                ["title" => "Basic Management Concepts", "abbreviation" => "MGMT 301", 'type' => "MGMT",
                 "description" => "Study of fundamental principles and processes available to the understanding
                 of management.",
                 "credits" => 3
                ],
                ["title" => "General Physics: Mechanics", "abbreviation" => "PHYS 211", 'type' => "PHYS",
                ...
                ["title" => "General Physics: Electricity and Magnetism", "abbreviation" => "PHYS 212",
                 'type' => "PHYS",
                 "description" => "Calculus-based study of the basic concepts of electricity and magnetism.",
                 "credits" => 4
                ],
                ["title" => "Elementary Probability", "abbreviation" => "STAT 318", 'type' => "STAT",
                ...
                ["title" => "Object-Oriented Software Design and Construction", "abbreviation" => "SWENG 311", 'type' => "SWENG",
                ...
                ["title" => "Software Engineering", "abbreviation" => "SWENG 411", 'type' => "SWENG",
                ...
                ["title" => "Software Architecture", "abbreviation" => "SWENG 421", 'type' => "SWENG",
                ...
                ["title" => "Software Verification, Validation, and Testing", "abbreviation" => "SWENG 431",
                 'type' => "SWENG",
                ...
                ["title" => "Embedded Real Time Systems", "abbreviation" => "SWENG 452", 'type' => "SWENG",
                 "description" => "The design and implementation of real time systems.",
                 "credits" => 3
                ],
                ["title" => "Software Engineering Design", "abbreviation" => "SWENG 480", 'type' => "SWENG",
                ...
                ["title" => "Software Engineering Project", "abbreviation" => "SWENG 481", 'type' => "SWENG",
